...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210419_lettersbycataco_d8524d16d42603e05820_20210419030410_archive.zip';
	const ARCHIVE_SIZE		 = '136693568';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'd8524d1-19030410';
    const SECONDARY_PACKAGE_HASH = 'dc89ed5-19030410';
	const VERSION			 = '1.4.0';
